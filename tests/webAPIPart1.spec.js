...
const { webAPIPart1ObjectRepository } = require("../wrapperFunction/webAPIPart1.spec");

const loginPayload = {"userEmail":"aadityamankar18@gmail.com","userPassword":"Pass@123"};
let token;

//before once all testcases
...
test('API Testing', async ({browser})=>
{
    ...
    const repo = new webAPIPart1ObjectRepository(page);
